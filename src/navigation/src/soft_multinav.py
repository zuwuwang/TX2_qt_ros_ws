...
class MultiNav():  
    ...
    def __init__(self):  
        ...
        locations['home_kitchen'] = Pose(Point(2.03, 0.755, 0.00146), Quaternion(0.000, 0.000, 0.000, 1.000))  
        locations['home_hall'] = Pose(Point(4.84, 0.874, 0.00254), Quaternion(0.000, 0.000, 0.000, 1.000))  
        locations['home_sofa'] = Pose(Point(7.86, 1.48, -0.0023), Quaternion(0.000, 0.000, 0.000, 1.000))  
        locations['home_refrigerator'] = Pose(Point(10.4, 2.17, 0.00779), Quaternion(0.000, 0.000, 1.000, 0.000)) 
        #locations['home_door'] = Pose(Point(-8.34, 2.50, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000))
	    ...
	    # tent42 speechFlag在这里改变，以便不用在上面while中被重复赋值，而且确保是justrun
            if not finished_within_time and self.speechFlag == 'justrun':  
                self.move_base.cancel_goal()  
