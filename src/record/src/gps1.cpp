...
void cal_dis(const std_msgs::String::ConstPtr& msg)
{
 ...
 msg2.lon0 = cur_gps.lon;
 msg2.lat0 = cur_gps.lat;
 msg2.lon1 = goal_gps.lon;
 msg2.lat1 = goal_gps.lat;
 webmap.publish(msg2);
 int dis;
...
int main(int argc, char **argv)
{
  ...
  webmap = n.advertise<record::lonlat>("sendgps", 1000);	
  ros::spin();
  return 0;
 /* while (ros::ok())
  {
