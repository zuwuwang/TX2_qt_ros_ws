...
if(NOT "/opt/ros/kinetic/include;/usr/include;include " STREQUAL " ")
  set(record_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros/kinetic/include;/usr/include;include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'record' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/qt_ros_ws/install/${idir}'.  ${_report}")
    endif()
